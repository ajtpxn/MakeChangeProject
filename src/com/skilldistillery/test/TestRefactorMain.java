...
public class TestRefactorMain {
		...
		while (stay) {
			...
			if (change == 0) {
				...
				while (dNum <= 8 ) {
					...
					last = intChange - dVal*denom == 0;
					System.out.print(printAnd(last));
					System.out.print(isZero(denom));
					System.out.print(singular(denom, dVal));
					intChange = intChange - dVal*denom;
					System.out.print(printComma(last || denom == 0));
					dNum = dNum +1;
	...
	public static String singular(int inputNum, int inputDenom) {
		...
		if (inputNum == 1) {
			switch (inputDenom){
			case 2000: output = " twenty";
			break;
			case 1000: output = " ten";
			break;
			case 500: output = " five";
			break;
			case 100: output = " one dollar bill";
			break;
			case 25: output = " quarter";
			break;
			case 10: output = " dime";
			break;
			case 5: output = " nickel";
			break;
			case 1: output = " penny";
			}
		}
			...
			switch (inputDenom){
			case 2000: output = " twenties";
			break;
			case 1000: output = " tens";
			break;
			case 500: output = " fives";
			break;
			case 100: output = " one dollar bills";
			break;
			case 25: output = " quarters";
			break;
			case 10: output = " dimes";
			break;
			case 5: output = " nickels";
			break;
			case 1: output = " pennies";
			}
		}
		else {
			output = "";
